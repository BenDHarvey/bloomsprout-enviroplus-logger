...
class Enviro:
    ...
    def display_and_return_readings(self):
        ...
        if mode == 10:
            ...
            self.save_data(4, gas_data.oxidising / 1000)
            self.save_data(5, gas_data.reducing / 1000)
            self.save_data(6, gas_data.nh3 / 1000)
            self.display_everything()
            pms_data = None
            try:
                ...
                self.save_data(7, float(pms_data.pm_ug_per_m3(1.0)))
                self.save_data(8, float(pms_data.pm_ug_per_m3(2.5)))
                self.save_data(9, float(pms_data.pm_ug_per_m3(10)))
                self.display_everything()
